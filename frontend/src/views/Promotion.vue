            ...
            <v-row>
             ...
             <v-col cols="12" sm="6" md="3">
                ...
                >
                  ...
                  <v-date-picker v-model="StartDates" @input="menu = false"></v-date-picker>
                </v-menu>
              </v-col>
              <v-col cols="12" sm="6" md="3">
                <v-menu
                ...
                >
                  ...
                  <v-date-picker v-model="EndDates" @input="menu = false"></v-date-picker>
                </v-menu>
              </v-col>
             </v-row>
             </v-container>
          ...
          <v-dialog v-model="dialog2" width="500">
                        <v-card>
                          <v-card-title class="red white--text" primary-title>
                            <div class="font-head-desing">โปรโมชั่น</div>
                          </v-card-title>
                          <v-card-text>
...
Promotion:{
  ...
  methods: {
    ...
    getCreateInsurance() {
      console.log("getCreateInsurance");
      http
        .get("/CreateInsurance")
        .then(response => {
          this.InsuranceID = response.data;
   ...
   // function เมื่อกดปุ่ม submit
    save() {
      ...
      console.log(this.Promotion.Insurance_id);
