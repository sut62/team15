<template>
  <div>
    <v-toolbar flat height="100px" tile color="deep-purple">
      <div height="110px">
      <v-img  dark src="../assets/Test1.png"></v-img></div>
      <v-spacer></v-spacer>
       <v-menu bottom left>
    ...
    <v-carousel height="600" whight="1165" tile cycle hide-delimiter-background show-arrows-on-hover>
